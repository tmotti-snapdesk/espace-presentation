...
import LeadFormSection from "@/components/showcase/LeadFormSection";
    ...
    <main>
      ...
      {espace.isLeadGen && (
        <LeadGenModal
          ...
          closable={espace.leadGenClosable}
        />
      )}
      ...
      {espace.isLeadGen && (
        <LeadFormSection espaceName={espace.name} espaceSlug={espace.slug} />
      )}
      <Contacts />
      <Reassurance />
    </main>
